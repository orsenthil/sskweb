...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ...
        ((
            ...
            ("/diagnostic-and-research-center/", "Diagnostic and Research Center"),
            ("/center-for-special-education/", "Center for Special Education"),
...
# (translatable)
CONTENT_FOOTER = 'Contents &copy; {date}         <a href="mailto:{email}">Spastics Society Of Karnataka</a> - Powered by         <a href="https://getnikola.com" rel="nofollow">Nikola</a>         {license}'
...
TWITTER_CARD = {
    ...
    'site': '@spastics_kar',         # twitter nick for the website
    'creator': '@spastics_kar',     # Username for the content creator / author.
}
